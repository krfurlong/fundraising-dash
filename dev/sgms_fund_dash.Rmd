...
sales.dat <- data.frame(
  date = c("2020-01-21", "2020-01-28", "2020-01-29", "2020-01-30"),
 # n.orders = c(22, 27),
  sixth.grade = c(0, 8, 8, 9), #6 is a guess
  other.grades = c(0, 22, 27, 27), 
  satterfields = c(0,0,0,11),
